...
public class UsuarioDAO {
    ...
    public boolean updatePerson (Usuario person){
        ...
        try {
            ...
            if(connect != null){
               ...
               pst.setInt(9, person.getUsrType());
    ...
    public boolean addPerson(Usuario person){
        ...
        try {
            ...
            if(connect != null){
                ...
                String sql = "INSERT INTO persona(id_number,id_type,name,last_name,date_of_birth,gender,email,phone, state, usr_type) VALUES(?,?,?,?,?,?,?,?,?)";
...
public ArrayList<Usuario> selectPerson(String filter, ArrayList<String>data){
...
try {
    ...
    while(rs.next()){
        ...
        person.setUsrType(rs.getInt("usr_type"));
